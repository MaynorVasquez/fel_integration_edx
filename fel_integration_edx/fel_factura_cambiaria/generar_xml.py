...
from ..fel_utils.fel_datos_certificacion import get_fel_config
from ..fel_utils.fel_series_electronicas import  get_fel_serie
...
def generar_xml_dte(sales_invoice_doc):
    ...
    series = getattr(pos_profile_doc, "custom_series", None) or "0"
